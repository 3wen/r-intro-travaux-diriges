...
\multicolumn{2}{c}{ } & \multicolumn{2}{c}{\textbf{Consonnance du nom}} & \multicolumn{1}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){3-4}
\textbf{Variable} & \textbf{Overall}, N = 4,870 & \textbf{Caucasien}, N = 2,435 & \textbf{Afro-americain}, N = 2,435 & \textbf{p-value}\\
\midrule
Genre &  &  &  & 0.4\\
...
\multicolumn{2}{c}{ } & \multicolumn{2}{c}{\textbf{Consonnance du nom}} & \multicolumn{1}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){3-4}
\textbf{Variable} & \textbf{Total}, N = 4,870 & \textbf{Caucasien}, N = 2,435 & \textbf{Afro-americain}, N = 2,435 & \textbf{p-valeur}\\
\midrule
Genre, n (\%) &  &  &  & 0.4\\
\hspace{1em}homme & 1,124 (23\%) & 575 (24\%) & 549 (23\%) & \\
\hspace{1em}femme & 3,746 (77\%) & 1,860 (76\%) & 1,886 (77\%) & \\
